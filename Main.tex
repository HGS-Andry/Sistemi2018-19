...
\theoremstyle{plain}					% osservazione
\newtheorem*{osservazione}{Oss}
\theoremstyle{remark}					% Nota bene
\newtheorem*{NB}{NB}
...
\DeclarePairedDelimiter{\BRP}{\bigg(}{\bigg)}
\DeclarePairedDelimiter{\BSP}{\bigg(}{\bigg)}
...
\include{./capitoli/cap5_TrasfDiFourier}
\include{./capitoli/cap6_Bode}
