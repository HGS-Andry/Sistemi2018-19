...
\chapter{Sistemi a tempo continuo}
	...
	\subsubsection{Esempi semplici}
		\begin{nexample}
			...
			\begin{figure}[H]
				\centering
				\subfloat[][\emph{Pendolo}]
				{\includegraphics[width=.27\textwidth]{immagini/cap3_Sistemi/pendolo.pdf}} \quad
				\subfloat[][\emph{Grafico che descrive l'andamento nel tempo del pendolo, come si può vedere tende a zero infatti il sistema è in equilibrio.}]
				{\includegraphics[width=.45\textwidth]{immagini/cap3_Sistemi/sistEquilib.pdf}} 
				\caption{ Sistema semplice: pendolo. }
%				\includegraphics[scale=0.7]{immagini/cap3_Sistemi/pendolo.pdf}
%				\caption{ Sistema semplice: pendolo. }
				\label{fig: pendolo}
			\end{figure}
