...
%TODO: chiedi meglio agli altri, sarà giusto il disegno? Ho cpaito bene qui?
...
%TODO: chiedi meglio agli altri, a me non sembra un insieme di punti finiti. A me sembra il piano complesso tolto un insieme di numeri finiti. Potete guardare nei vostriappunti?
...
\textbf{???}%TODO: cos'è questo? Titolo ?
...
\begin{proof}[Dim:] voglio dimostrare che r=1 è proprio il raggio di convergenza.\\
	...
	% La magia di Gregorio è molto potente qui, infatti non ho capito molto i passaggi ma ho controllato su Internet e dovrebbero essere giusti
	Il raggio di convergenza è proprio r=s=1 cioè con $ |r| < 1$ la serie converge (dà un numero finito).
	
\end{proof}

%TODO: qui mi sono persa molto
\textbf{ES B):}\\
